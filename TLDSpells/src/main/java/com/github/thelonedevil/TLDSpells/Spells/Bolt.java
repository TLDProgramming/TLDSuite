...
public class Bolt {
	...
	public static Entity cast(Player p, Class<? extends Substance> projectile) {
		...
		scene.impulse(VectorMath.getDirection(p.getPhysics().getRotation()).multiply(250)).setMovementVelocity(Vector3.FORWARD).force(Vector3.FORWARD);// TODO: Need real parameters

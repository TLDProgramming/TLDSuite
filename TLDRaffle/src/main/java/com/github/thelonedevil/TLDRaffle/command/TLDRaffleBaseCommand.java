 ...
 */
public class TLDRaffleBaseCommand {
	private final TLDRafflePlugin plugin;

	public TLDRaffleBaseCommand(TLDRafflePlugin instance) {
	...
	public void exampleBaseCommand(CommandSource source, CommandArguments args) throws CommandException {
		...
		source.sendMessage("The TLDRaffle plugin base command has been successfully issued. (Type a sub-command)");
	}
}